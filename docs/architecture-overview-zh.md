...
本文档不是理论重述——理论请阅读 [eva-theory](https://github.com/slamslammo/eva-theory)。本文档不是实现日志——当前框架落地情况请阅读 [`eva-framework-implementation.md`](eva-framework-implementation.md)。本文档是架构粘合层：展示各部分如何组装在一起、哪些不变量在各部分之间恒成立。
