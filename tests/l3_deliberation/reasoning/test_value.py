...
class ValueJudgmentTests(unittest.TestCase):
    ...
    def test_semantic_pattern_bias_adds_small_bounded_bonus_for_matching_profile(self) -> None:
        ...
        self.assertGreater(assessments[1].learning_bias, baseline_assessments[1].learning_bias)
        self.assertIn("semantic_pattern_bias", assessments[1].bias_reasons)
        self.assertLessEqual(assessments[1].learning_bias - baseline_assessments[1].learning_bias, 0.08)

    def test_low_confidence_semantic_pattern_does_not_apply_bias(self) -> None:
        deliberation_input = build_deliberation_input(
            signal_batch={
                "signals": [{"class": "status"}, {"class": "threat"}],
                "summary": {
        ...
        self.assertEqual(assessments[1].learning_bias, 0.0)
        self.assertNotIn("semantic_pattern_bias", assessments[1].bias_reasons)
    ...
    def test_inherited_prior_bias_adds_small_bounded_bonus(self) -> None:
        deliberation_input = build_deliberation_input(
            signal_batch={
                "signals": [{"class": "status"}, {"class": "threat"}],
                "summary": {
        ...
        self.assertGreater(assessments[0].learning_bias, baseline_assessments[0].learning_bias)
        self.assertIn("inherited_prior_bias", assessments[0].bias_reasons)
        self.assertLessEqual(assessments[0].learning_bias - baseline_assessments[0].learning_bias, 0.06)

    def test_low_evidence_inherited_prior_does_not_apply_bias(self) -> None:
        deliberation_input = build_deliberation_input(
            signal_batch={
                "signals": [{"class": "status"}, {"class": "threat"}],
                "summary": {
        ...
        self.assertEqual(assessments[0].learning_bias, 0.0)
        self.assertNotIn("inherited_prior_bias", assessments[0].bias_reasons)
