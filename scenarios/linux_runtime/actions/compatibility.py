"""Linux runtime bounded compatibility action policy for Phase A."""
...
DEFAULT_RESPONSE_MODE = "pressure_led_compatibility"
...
def build_integrity_response_candidates(
    ...
    """Build the first-pass Linux runtime candidate set for one integrity pressure."""
...
def filter_response_candidates(
    ...
    """Filter Linux runtime candidates using the current integrity boundaries."""
...
def select_integrity_response(
    ...
    *,
    ...
    """Return the Linux runtime mediated selection for one integrity pressure."""

    from eva.l3_deliberation.tool_edge.tool_registry import bridge_policy_from_release_context
...
def select_response_action(
    ...
    *,
    ...
    """Select the final Linux runtime Step 2 action after filtering."""

    from eva.l3_deliberation.tool_edge.tool_registry import ResponseFilterDecision, ResponseSelection
...
def execute_linux_runtime_action(
    store: StateStore,
    pressure: ActivePressure,
    ...
    *,
    ...
    """Execute the selected Linux runtime action and return the existing bounded payload."""
