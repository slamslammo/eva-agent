    ...
    return {
        "host_continuity": {
            ...
            "rate_context": {
                ...
                "window_sec": config.recent_event_window_sec,
                "restart_count_delta": restart_change["delta"],
                "restart_change_per_sec": restart_change["change_per_sec"],
                "restart_rate_per_sec": recent_restart_count / config.recent_event_window_sec,
        ...
        "runtime_integrity": {
            ...
            "heartbeat_age_sec": runtime_state.heartbeat_age_sec,
            ...
            "rate_context": {
                ...
                "yield_rate_per_sec": recent_yield_count / config.recent_event_window_sec,
                ...
                "distress_rate_per_sec": recent_distress_count / config.recent_event_window_sec,
        ...
        "anomaly_accumulation": {
            ...
            "rate_context": {
                ...
                "error_rate_per_sec": recent_error_count / config.recent_event_window_sec,
                ...
                "anomaly_rate_per_sec": anomaly_count / config.recent_event_window_sec,
                "direction": _combine_directions(
