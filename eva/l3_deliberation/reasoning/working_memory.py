...
from ..memory import derive_habit_skills
from ..memory import NullWorkingMemoryAdapter, WorkingMemoryAdapter, WorkingMemoryAdapterRequest, WorkingMemoryAdapterResponse
...
def _recent_learning_outcomes(learning_outcomes: list[dict[str, Any]], *, situation_key: str, limit: int) -> list[dict[str, Any]]:
    ...
    return [_recent_outcome_trace(record) for record in recent]
