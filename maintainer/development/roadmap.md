...
| A-1 ~ A-4 semantic realignment slices | 按 v0.5 主线补齐 drive-weighted judgment、pre-generative anchor restriction、salience-weighted episodic encoding 与 structural default inhibition | 已完成阶段性里程碑 | `docs/current-status.md`、`maintainer/development/current-intake.md`、commit `563f235` | 先完成 external review handoff，再规划下一 slice |
